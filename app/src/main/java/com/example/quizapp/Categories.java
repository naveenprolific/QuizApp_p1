...
public class Categories extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if(v==b1){
            finish();
            Intent i2 = new Intent(getApplicationContext(),Cse.class);
            startActivity(i2);
        }
        if(v==b2){
            finish();
            Intent i3 = new Intent(getApplicationContext(),Hist.class);
            i3.putExtra("activity","History");
            startActivity(i3);
        }
        if(v==b3){
            finish();
            Intent i4 = new Intent(getApplicationContext(),Hist.class);
            i4.putExtra("activity","Math");
            startActivity(i4);
        }
        if(v==b4){
            finish();
            Intent i5 = new Intent(getApplicationContext(),Hist.class);
            i5.putExtra("activity","Sports");
            startActivity(i5);
        }if(v==b5){
            finish();
            Intent i6 = new Intent(getApplicationContext(),Hist.class);
